...
def prepare_drain_data_for_model(ModelBuilderObject,
    ...
    MBO.parameters.create_model_parameter('drain_drop', value=0.01)
    MBO.parameters.parameter_options('drain_drop', 
                                          PARTRANS='log', 
                                          PARCHGLIM='factor', 
                                          PARLBND=0.001, 
                                          PARUBND=0.1, 
                                          ...
                                          SCALE=1, 
                                          OFFSET=0)
    MBO.parameters.create_model_parameter('kv_drain', value=5E-3)
    MBO.parameters.parameter_options('kv_drain', 
                                          PARTRANS='log', 
                                          PARCHGLIM='factor', 
                                          PARLBND=1E-8, 
                                          PARUBND=20, 
    ...
    for drain_cell in MBO.polyline_mapped['Drain_Clip_model.shp']:
        ...
        drain_bed = MBO.model_mesh3D[0][0][row][col] - MBO.parameters.param['drain_drop']['PARVAL1']
        drain_cond = drain_cell[1] * drain_width_avg * MBO.parameters.param['kv_drain']['PARVAL1'] / drain_bed_thickness
