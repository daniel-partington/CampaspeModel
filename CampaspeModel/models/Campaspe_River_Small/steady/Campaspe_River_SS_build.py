...
SS_model = GWModelBuilder(name="steady_state", 
                          data_folder=r"C:\Workspace\part0075\MDB modelling\testbox\input_data\\",
                          model_data_folder=r"C:\Workspace\part0075\MDB modelling\testbox\Campaspe_River_Small\steady_state\\",
...
custom_data = \
    Campaspe_data.process_custom_scripts_and_spatial_data(SS_model, 
                                                          ...
                                                          verbose=True,
                                                          model_boundary_file="Campaspe_River_ Buffer_5km_zone55.shp")
