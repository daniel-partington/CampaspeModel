...
ngis_bore_shp = r"C:\Workspace\part0075\MDB modelling\ngis_shp_VIC\ngis_shp_VIC\NGIS_Bores.shp"
...
WGWbound_poly = SS_model.read_polyline("western_head.shp", path=CONFIG.get_setting(['model_build', 'input_data']))
EGWbound_poly = SS_model.read_polyline("eastern_head.shp", path=CONFIG.get_setting(['model_build', 'input_data']))
